...
class GaussianProcessRegressorOptimizer(AbstractOptimizer):
    ...
    def __init__(self, design_space):
        ...
        self.lowpowertime = 0
        self.lowpowertime_upperbound = 3
    ...
    def suggest(self):
        ...
        if self.oa:
            ...
            initial_suggest =  [
                self.design_space.vec_to_microarchitecture_embedding(
                    self.design_space.idx_to_vec(_x_guess)
                ) for _x_guess in [1778, 3407, 815, 3389, 2759, 1796, 2426, 4370, 1859, 3254, 3431, 1826, 4388, 2444, 2741, 797, 1676, 3400, 3507, 158, 5027, 2107, 2976, 2106, 3181]
            ]
        if not self.first:
            ...
            if self.lowpowertime >= self.lowpowertime_upperbound:
                self.lowpowertime = 0
